      ...
      {selectedRide && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-md relative">
            ...
            <p className="text-gray-600 text-sm">Rider: {selectedRide.riderName}</p>
            <p className="text-gray-600 text-sm">Rider ID: {selectedRide.riderId}</p>
            <p className="text-gray-600 text-sm">Vehicle: {selectedRide.vehicle}</p>
            <p className="text-gray-600 text-sm">Pickup Location: {selectedRide.location}</p>

            <div className="flex justify-between items-center border-t border-gray-200 pt-4 mt-4">
              <span className="font-semibold text-gray-700">Total:</span>
              <span className="text-lg font-bold text-gray-800">{selectedRide.price}</span>
            </div>
